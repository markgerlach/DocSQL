...
namespace DocSQL_2017
{
	public class Utils
	{
		...
		public static string AttentuationPhrase = "DocSQL Rocks!";
		...
		public static void GetAppIcons(string extension)
		{
			...
			//List<string> extensions = DocSQL_2017.Attachment.GetDistinctFromDB(AttachmentField.OriginalExtension);
			...
			//		Icon ico = DocSQL_2017.Model.ExtractIcon.GetIcon(newFileName, true);		// Small
			//		if (ico != null &&
			...
			//		ico = DocSQL_2017.Model.ExtractIcon.GetIcon(newFileName, false);		// Large
			//		if (ico != null &&
		...
		//{
		//    return SendEMail("DocSQL@test.com",
		//        to, 
		//        cc, 
		//        subject, 
		//        body, 

...
namespace DocSQL_2017
{
	...
	#region ProjectItemBuiltEventArgs
	/// <summary>
	/// Custom class for Search event args that allow the 
	/// passing back of the datarow for the selected row in the grid
	/// </summary>
	public class ProjectItemBuiltEventArgs : EventArgs
	{
		//private string _fileName = string.Empty;
		//private string _desc = string.Empty;
		//private decimal _percentageComplete = 0.00M;
		//private BackgroundWorker _bw = null;
		private BuildItem _buildItem = null;

		//public ProjectItemBuiltEventArgs(string fileName, decimal percentageComplete, string desc, BackgroundWorker bw)
		public ProjectItemBuiltEventArgs(BuildItem buildItem)
		{
			_buildItem = buildItem;
		}

		public ProjectItemBuiltEventArgs()
		{
		}
	...
	#endregion ProjectItemBuiltEventArgs

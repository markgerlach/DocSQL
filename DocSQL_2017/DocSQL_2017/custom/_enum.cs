...
namespace DocSQL_2017
{
	...
	public enum DocSQLPrintOrientation : int
	{
		Portrait = 0,
		Landscape
	}
	...
	public enum ScreenObjectFormType : int
	{
		...
		// SELECT TOP 10000 [sCaseDesc] FROM [DocSQL].[dbo].[vwNavBarObjectItems] ORDER BY [sCaseDesc]
	...
	public enum DocSQLScreenSize : int
	{
	...
	public enum SystemSettingDropDown : int
	{
		...
		ManEngDieStatus,
		ManEngOperation,
		ManEngInspectionType,
		ManEngStorageSite,
		ManEngOnsiteLocation,
	...
	public enum ForgeJoystickState : int
	{
		Neutral = 0,
		Forge,
		Return,
	...
	{
		NotSpecified,
		HandGrinder, SwingGrinder, BilletGrinder, BlastCabinet, BlastConveyor, BlastBooth,       //Conditioning
		VerticalMill, TurnCenter, GantryMill, HorizontalMill, Lathe, RadialDrill                //Machine Shop
	}

	public enum MachineDepartment
	{
		NotSpecified, Conditioning, MachineShop
	}

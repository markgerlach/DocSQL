...
//using DocSQL_2017.WinChart.usercontrols;

namespace DocSQL_2017.controls
{
	public class mgDevX_Print
	{
		#region Private Variables
		//private DocSQLPrintOrientation _orientation = DocSQLPrintOrientation.Portrait;
		...
		/// </summary>
		//public DocSQLPrintOrientation Orientation
		//{
		...
		public XtraReport GenerateReport()
		{
			...
			// Set the landscape
			//rpt.Landscape = (_orientation == DocSQLPrintOrientation.Landscape ? true : false); 
			...
			{
				//if (cntrl is ucWinChart)
				//{
				//	#region Print Chart
				//	XRChart rptChart = new XRChart();
				//	IChartContainer cc = rptChart as IChartContainer;
				//	cc.Chart.Assign(((IChartContainer)((ucWinChart)cntrl).DevXChart).Chart);

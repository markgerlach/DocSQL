...
namespace DocSQL_2017
{
	public class mgDevX_GridControl_Print
	{
		...
		public delegate void DetailCreatedEventHandler(object sender, DocSQLCreateAreaEventArgs e);
		public event DetailCreatedEventHandler DetailCreated;
		public void OnDetailCreated(DocSQLCreateAreaEventArgs e)
		{
	...
	public class DocSQLCreateAreaEventArgs : EventArgs
	{
		private int _pageNum;
		private int _numOfTotal;

		public DocSQLCreateAreaEventArgs() 
		{
		}

namespace DocSQL_2017
{
	partial class ucErrorView
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnContinueProcessing = new mgDevX_SimpleButton();
			this.btnCancelProcessing = new mgDevX_SimpleButton();
			this.btnPrint = new mgDevX_SimpleButton();
			this.btnWarnings = new mgDevX_SimpleButton();
			this.btnInformation = new mgDevX_SimpleButton();
			this.btnErrors = new mgDevX_SimpleButton();
			this.gridError = new mgDevX_GridControl();
			...
			this.btnContinueProcessing.ButtonColor = mgButtonGUIButtonColor.Green;
			...
			this.btnCancelProcessing.ButtonColor = mgButtonGUIButtonColor.Red;
			...
			this.btnWarnings.ButtonColor = mgButtonGUIButtonColor.Green;
			...
			this.btnInformation.ButtonColor = mgButtonGUIButtonColor.Green;
			...
			this.btnErrors.ButtonColor = mgButtonGUIButtonColor.Green;
		...
		private mgDevX_SimpleButton btnErrors;
		private mgDevX_GridControl gridError;
		private DevExpress.XtraGrid.Views.Grid.GridView gridViewError;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem1;
		private DevExpress.XtraLayout.EmptySpaceItem emptySpaceItem1;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem2;
		private mgDevX_SimpleButton btnWarnings;
		private mgDevX_SimpleButton btnInformation;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem3;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem4;
		private mgDevX_SimpleButton btnCancelProcessing;
		private mgDevX_SimpleButton btnPrint;
		...
		private mgDevX_SimpleButton btnContinueProcessing;
